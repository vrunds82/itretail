    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.center,
          ...
          children: [
           Text(status[Global.currentLevel==level.toString() && Global.levelStatus=="0"?4:int.parse(Global.currentLevel)>level?3:int.parse(Global.levelStatus)],style: TextStyle(
             fontSize: 24,
               color: currentColor,
