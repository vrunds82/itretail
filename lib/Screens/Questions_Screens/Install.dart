...
class InstalledStoreImages extends StatefulWidget {
  VoidCallback callback;
  static String route = "storePicture";


  InstalledStoreImages({this.callback});

  @override
  _InstalledStoreImagesState createState() => _InstalledStoreImagesState();
}

class _InstalledStoreImagesState extends State<InstalledStoreImages> {
  ...
  async {
    ...
    if(int.parse(Global.currentLevel)==8 && int.parse(Global.levelStatus)==0){
      isLoading =false;
      setState(() {
                        ...
                        Expanded(
                            child: Column(
                              children: [
                                ...
                                int.parse(Global.currentLevel)>10?SizedBox():Padding(
                                  padding: const EdgeInsets.all(15.0),
                                  child: Row(
                                    children: [
                                      Expanded(
                                        child:
                                        int.parse(Global.currentLevel)==10 && int.parse(Global.levelStatus)==0?
