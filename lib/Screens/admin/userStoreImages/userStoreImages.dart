...
class UserStoreImages extends StatefulWidget {

  VoidCallback callback;
  UserStoreImages({this.callback});
  @override
  _UserStoreImagesState createState() => _UserStoreImagesState();
}

class _UserStoreImagesState extends State<UserStoreImages> {
  bool isLoading = true;
  bool isError = false;
