...
class _AllUsersState extends State<AllUsers> {
                ...
                children: [
                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child: Row(
                                                                  children: [
                                                                    ...
                                                                    Text(
                                                                      allUsers[index].oneToOne != null &&
                                                                              allUsers[index].oneToOne !=
                                                                                  ""
                                                                          ? allUsers[index].oneToOne.substring(
                                                                              0,
                                                                              16)
                                                                          : "NA",
                                                                      style: TextStyle(
                                                                        ...
                                                                        onTap:
                                                                          ...
                                                                          SetTime.dateTimePicker(
                                                                            ...
                                                                            if (date != null &&
                                                                              ...
                                                                              await APIs.updateDate(context: context, uid: allUsers[index].id, level: 8.toString(), date: date.toString());
                                                                              getAllUsers();
                                                                            }
                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child: Row(
                                                                  children: [
                                                                    ...
                                                                    Text(
                                                                      allUsers[index].deploymentCall != null &&
                                                                              allUsers[index].deploymentCall !=
                                                                                  ""
                                                                          ? allUsers[index].deploymentCall.substring(
                                                                              0,
                                                                              16)
                                                                          : "NA",
                                                                      style: TextStyle(
                                                                        ...
                                                                        onTap:
                                                                          ...
                                                                          SetTime.dateTimePicker(
                                                                            ...
                                                                            if (date != null &&
                                                                              ...
                                                                              await APIs.updateDate(context: context, uid: allUsers[index].id, level: 91.toString(), date: date.toString());
                                                                              getAllUsers();
                                                                            }
                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child: Row(
                                                                  children: [
                                                                    ...
                                                                    Text(
                                                                      allUsers[index].install != null &&
                                                                              allUsers[index].install !=
                                                                                  ""
                                                                          ? allUsers[index].install.substring(
                                                                              0,
                                                                              10)
                                                                          : "NA",
                                                                      style: TextStyle(
                                                                    ...
                                                                    GestureDetector(
                                                                        onTap:
                                                                          ...
                                                                          SetTime.datePicker(
                                                                            ...
                                                                            if (date !=
                                                                                null) {
                                                                              await APIs.updateDate(context: context, uid: allUsers[index].id, level: 9.toString(), date: date.toString());
                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child: Row(
                                                                  children: [
                                                                    ...
                                                                    Text(
                                                                      allUsers[index].golive != null &&
                                                                              allUsers[index].golive !=
                                                                                  ""
                                                                          ? allUsers[index].golive.substring(
                                                                              0,
                                                                              10)
                                                                          : "NA",
                                                                      style: TextStyle(
                                                                ...
                                                                children: [
                                                                  GestureDetector(
                                                                      onTap:
                                                                        ...
                                                                        String
                                                                            url =
                                                                            '${BaseURL}docs/${allUsers[index].csv}';
                                                                        if (await canLaunch(
                                                                            url)) {
                                                                          await launch(
                                                                              url);
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      ColorCodeMeaning(
                        color: Colors.red,
                        text: "Rejected and waiting for customer update",
                      ),
                      ColorCodeMeaning(
                        color: Colors.green,
                        text: "Completed",
  ...
  getAllUsers() async {
    ...
    await http.post(APIs.getAllCustomer, body: {"type": "0","key":Global.key}).then((response) {
      print(response.body);
      users = response.body;
      var parsedJson = jsonDecode(response.body);

      if (parsedJson['status'] == 1) {
        allUsers = (parsedJson['data'] as List)
