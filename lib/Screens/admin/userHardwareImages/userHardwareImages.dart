...
class UserHardwareImages extends StatefulWidget {

  VoidCallback callback;
  UserHardwareImages({this.callback});
  @override
  _UserHardwareImagesState createState() => _UserHardwareImagesState();
}

class _UserHardwareImagesState extends State<UserHardwareImages> {
  bool isLoading = true;
  bool isError = false;
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text("Back of Computer Ports"),
                                  ViewImages(images: hardwareImagesModel.computerports,),
                                ],
                              ):SizedBox(),
                              ...
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text("Scale Model Number and Cables"),
                                  ViewImages(images: hardwareImagesModel.scale,),
                                ],
                              ):SizedBox(),
                              ...
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text("Scanner Model Number and Cables"),
                                  ViewImages(images: hardwareImagesModel.scanner,),
                                ],
                              ):SizedBox(),
                              ...
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text("Printer Model Number and Cables"),
                                  ViewImages(images: hardwareImagesModel.printer,),
                                ],
                              ):SizedBox(),
