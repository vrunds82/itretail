...
class UserFinalPayment extends StatefulWidget {

  VoidCallback callback;
  UserFinalPayment({this.callback});
  @override
  _UserFinalPaymentState createState() => _UserFinalPaymentState();
}

class _UserFinalPaymentState extends State<UserFinalPayment> {
  bool isLoading = true;
  bool isError = false;
